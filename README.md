...
[![Build Status](https://drone.xataz.net/api/badges/xataz/docker-nextcloud/status.svg)](https://drone.xataz.net/xataz/docker-nextcloud)
[![](https://images.microbadger.com/badges/image/xataz/nextcloud.svg)](https://microbadger.com/images/xataz/nextcloud "Get your own image badge on microbadger.com")
[![](https://images.microbadger.com/badges/version/xataz/nextcloud.svg)](https://microbadger.com/images/xataz/nextcloud "Get your own version badge on microbadger.com")

### Features
- Based on Alpine Linux.
- Bundled with nginx and PHP 7.1 (xataz/nginx-php image).
...
- **NEXTCLOUD_VER** : version of nextcloud
...
- **/app/nextcloud/themes** : Nextcloud themes location.
...
```
docker pull xataz/nextcloud:10.0 && docker pull mariadb:10
...
You can take a look at my brand new image [xataz/reverse-nginx](https://hub.docker.com/r/xataz/reverse-nginx/). It was made with security and ease-of-use in mind, using the latest versions of nginx and OpenSSL. It also provides SSL/TLS automation with [lego](https://github.com/xenolf/lego), a Let's Encrypt client. Also, no need to bother about configuration files! This image does litterally everything for you.
